...
{
    public partial class FrmRptEfectividadComparativaEnvGen2 : Form
    {
        ...
        public FrmRptEfectividadComparativaEnvGen2()
        {
            InitializeComponent();
        }
        ...
        private void BtnConsular_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dt = BLReportes.RptEfectividadComparativaGenEnv2(cboPrograma.SelectedValue.ToString(), codPtoCob,
                ...
                string titulo = "EPORTE DE EFECTIVIDAD DE PLANILLA GENERADA Y ENVIADA VS. EJECUTADA COMPARATIVA MES A MES POR " + p1;
                ...
                string reportSource = chkPCobranza.Checked ? ObtenerRutaReporteTareaje_MOD_CXC("RptEfectividadComparativaPllaEnvGen2") : chkDepartamento.Checked ? ObtenerRutaReporteTareaje_MOD_CXC("RptEfectividadComparativaPllaEnvGen2Departamento") : ObtenerRutaReporteTareaje_MOD_CXC("RptEfectividadComparativaPllaEnvGen2Institucion");
