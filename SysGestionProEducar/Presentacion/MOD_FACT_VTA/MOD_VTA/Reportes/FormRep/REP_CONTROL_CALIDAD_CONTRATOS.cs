...
{
    public partial class REP_CONTROL_CALIDAD_CONTRATOS : Form
    {
        ...
        public REP_CONTROL_CALIDAD_CONTRATOS()
        {
            InitializeComponent();
        }

        private void REP_CONTROL_CALIDAD_CONTRATOS_Load(object sender, EventArgs e)
        {
