...
{
    public partial class PEDIDO2 : Form//, IForm
    {
        ...
        string numeracion;
        bool bandera = false; string codigo_persona = "";
        public PEDIDO2(string AÑO, string MES, DateTime FECHA_INI, DateTime FECHA_GRAL, string COD_MOD, string TIPO_USU, string COD_USU, MODULOS_VENTAS modulos_ventas)
        {
            InitializeComponent();
            this.AÑO = AÑO;
            this.MES = MES;
        ...
        private void PEDIDO2_Load(object sender, EventArgs e)
        {
            KeyPreview = true;
            DATAGRID();
            ...
            grbNroReporte.Visible = false;
            tltPreventa.SetToolTip(btnNroReporte, "Asignar Número de \nReporte Automático");
            lblMenNroRepo1.Visible = false;
            lblMenNroRepo2.Visible = false;
            lblMenNroRepo3.Visible = false;
            lblMenNroRepo4.Visible = false;
            ptbGato.Visible = false;
            //
        ...
        private void CARGAR_PUNTO_COBRANZA()
        {
            ...
            //AQUI cuando sea Tipo Visa ya no debe entrar aqui sino que debe llenar cboptocob con ptocob 172 osea Pto Vta Otros(Varios)
        ...
        public void DATAGRID()
        {
            //pccTo.FE_AÑO = AÑO;
            //pccTo.FE_MES = MES;
            pccTo.FECHA_GRAL = FECHA_GRAL;
            pccTo.TIPO_USU = TIPO_USU;//DE MOMENTO ESTO SALE DE INICIO (LOGIN)
            pccTo.COD_USU = COD_USU;
            dtPreContrato = pccBLL.obtenerPreContratoCabeceraBLL(pccTo);
            DGW.Rows.Clear();//limpiamos y luego si hay registros se pintarán
            lbl_nro_reg_docs.Text = "Nro de Registros : 0";
            if (dtPreContrato.Rows.Count > 0)
            {
                lbl_nro_reg_docs.Text = "Nro de Registros : " + dtPreContrato.Rows.Count.ToString();
                foreach (DataRow rw in dtPreContrato.Rows)
                {
                    ...
                    row.Cells["Fecha"].Value = Convert.ToDateTime(rw["Fecha"]).Date;
                    ...
                    row.Cells["FEC_PRIMER_VENC"].Value = Convert.ToDateTime(rw["FEC_PRIMER_VENC"]).Date;
                    row.Cells["NRO_DIAS_VENC"].Value = rw["NRO_DIAS_VENC"].ToString();
                    row.Cells["FEC_CUO_MEN"].Value = Convert.ToDateTime(rw["FEC_CUO_MEN"]).Date;
        ...
        private void DATAGRID_ANTIGUO()
        {
            ...
            DGW.Columns[38].Visible = false;
            DGW.Columns[39].Visible = false;
            DGW.Columns[40].Visible = false;
            DGW.Columns[41].Visible = false;
            DGW.Columns[42].Visible = false;
            //DGW.Columns[43].Visible = false;
            //DGW.Columns[44].Visible = false;
            //DGW.Columns[45].Visible = false;
            //DGW.Columns[46].Visible = false;
            DGW.Columns[47].Visible = false;
            //DGW.Columns[48].Visible = false;
            DGW.Columns[49].Visible = false;
            DGW.Columns[50].Visible = false;
            DGW.Columns[51].Visible = false;
            DGW.Columns[52].Visible = false;
            DGW.Columns[53].Visible = false;
            //DGW.Columns[1].Width = 170;
            //DGW.Columns[3].Width = 120;
            DGW.Columns[5].Width = 230;
            DGW.Columns[7].Width = 60;
            DGW.Columns[8].Width = 70;
            DGW.Columns[8].DefaultCellStyle.Format = "d";
            //DGW.Columns[16].Width = 30;
            DGW.Columns[19].Width = 40;
            DGW.Columns[20].Width = 30;
            DGW.Columns["NRO_REPORTE"].Visible = true;
            DGW.Columns["NRO_REPORTE"].HeaderText = "N° Reporte";
            DGW.Columns["NRO_REPORTE"].Width = 70;
            DGW.Columns["NRO_REPORTE"].DisplayIndex = 6;
            DGW.Columns["TOTAL_CONTRATO"].Visible = true;
            DGW.Columns["TOTAL_CONTRATO"].HeaderText = "Imp Total";
            DGW.Columns["TOTAL_CONTRATO"].Width = 65;
            DGW.Columns["TOTAL_CONTRATO"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            DGW.Columns["TOTAL_CONTRATO"].DisplayIndex = 6;
            DGW.Columns["COD_INSTITUCION"].Visible = false;
            DGW.Columns["DESC_INST"].Visible = false;
            DGW.Columns["COD_LUG_VTA"].Visible = false;
            DGW.Columns["Contrato"].DisplayIndex = 0;
            DGW.Columns["Cliente"].DisplayIndex = 1;
            //DGW.Columns["Fecha"].DisplayIndex = 4;
            DGW.Columns["Fecha"].Visible = true;
            DGW.Columns["Fecha"].HeaderText = "Fe Contrato";
            DGW.Columns["Fecha"].Width = 75;
            DGW.Columns["Fecha"].DisplayIndex = 4;
            DGW.Columns["FEC_PRIMER_VENC"].Visible = true;
            DGW.Columns["FEC_PRIMER_VENC"].HeaderText = "Fec 1er Ven";
            DGW.Columns["FEC_PRIMER_VENC"].Width = 75;
            DGW.Columns["FEC_PRIMER_VENC"].DisplayIndex = 7;
            DGW.Columns["IMP_CUOTA_INICIAL"].Visible = true;
            DGW.Columns["IMP_CUOTA_INICIAL"].HeaderText = "Imp 1er Ven";
            DGW.Columns["IMP_CUOTA_INICIAL"].Width = 75;
            DGW.Columns["IMP_CUOTA_INICIAL"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            DGW.Columns["IMP_CUOTA_INICIAL"].DisplayIndex = 8;
            DGW.Columns["FEC_CUO_MEN"].Visible = true;
            DGW.Columns["FEC_CUO_MEN"].HeaderText = "Fec 2do Ven";
            DGW.Columns["FEC_CUO_MEN"].Width = 75;
            DGW.Columns["FEC_CUO_MEN"].DisplayIndex = 9;
            DGW.Columns["IMP_CUOTA_MES"].Visible = true;
            DGW.Columns["IMP_CUOTA_MES"].HeaderText = "Imp 2do Ven";
            DGW.Columns["IMP_CUOTA_MES"].Width = 75;
            DGW.Columns["IMP_CUOTA_MES"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            DGW.Columns["IMP_CUOTA_MES"].DisplayIndex = 10;
            DGW.Columns["DIAS"].Visible = true;
            DGW.Columns["DIAS"].HeaderText = "Dias de PreVenta";
            DGW.Columns["DIAS"].Width = 100;
            DGW.Columns["DIAS"].DisplayIndex = 13;
            DGW.Columns["VENDEDOR"].Visible = true;
            DGW.Columns["VENDEDOR"].HeaderText = "Vendedor";
            DGW.Columns["VENDEDOR"].Width = 150;
            DGW.Columns["VENDEDOR"].DisplayIndex = 25;
            DGW.Columns["DESC_PTO_VEN"].HeaderText = "Punto de Venta";
            DGW.Columns["DESC_PTO_VEN"].Width = 120;
            DGW.Columns["DESC_PTO_COB"].HeaderText = "Punto de Cobranza";
            DGW.Columns["DESC_PTO_COB"].Width = 120;
            DGW.Columns["IMPORTE_PROTECCION"].Visible = false;
            DGW.Columns["NRO_CUOTAS"].Visible = true;
            DGW.Columns["NRO_CUOTAS"].HeaderText = "N°Cuotas";
            DGW.Columns["NRO_CUOTAS"].Width = 65;
            DGW.Columns["NRO_CUOTAS"].DisplayIndex = 14;
            //DGW.Columns["Cie."].DisplayIndex = 5;
            //DGW.Columns["Aprob"].DisplayIndex = 6;
            //DGW.Columns["Anul"].DisplayIndex = 7;
        ...
        private void CARGAR_TIPO_PLANILLA()
        {
            ...
            {
                //cbo_tipo_planilla.ValueMember = "COD_TIPO_OPERACION";
        ...
        private void PEDIDO2_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void btnNuevoCliente_Click(object sender, EventArgs e)
        {
            ...
            if (frm.ShowDialog() == DialogResult.OK)
            {
                if (Properties.Settings.Default.PER == "1")
                {
                    ...
                    txt_doc_per.Text = "";
                    bandera = true;
                    codigo_persona = frm.txt_cod.Text;
                    ...
                    //perTo.COD_PER = codigo_persona;
                    //DataTable dtPersona = perBLL.obtenerPersonaxCodPerBLL(perTo);
                    //TXT_COD.Text = dtPersona.Rows[0]["COD_PER"].ToString();
                    //TXT_DESC.Text = dtPersona.Rows[0]["DESC_PER"].ToString();
                    //txt_doc_per.Text = dtPersona.Rows[0]["NRO_DOC"].ToString();
                    COD_INSTITUCION1 = frm.cbo_institucion.SelectedValue.ToString();//lo trae para el punto de venta
                    CARGAR_NIVEL_INSTITUCIONES(COD_INSTITUCION1);
        ...
        private void CARGAR_NIVEL_INSTITUCIONES(string cod_institucion, string cod_nivel_institucion = "01")
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                cboNivelInstituciones.SelectedValue = cod_nivel_institucion;
            }
        }
        ...
        private void LIMPIAR_CABECERA()
        {
            ...
            chbVerNroRepManual.Checked = false;
            txt_oc.Text = "";
        ...
        public void DGW_CAB_DIALOG()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                frmKit.lbl_cantidad_a_ingresar.Visible = false;
                frmKit.txt_cantidad_a_ingresar.Visible = false;
                int i = 0;
                do
                {
        ...
        private void btn_grabar_Click(object sender, EventArgs e)
        {
            ...
            DialogResult rs = MessageBox.Show("¿ Esta seguro de grabar un nuevo Pre-Contrato ?", "MENSAJE", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            if (rs == DialogResult.Yes)
            {
                DialogResult rsNroRepo = DialogResult.OK;
                if (txt_oc.Text.Trim() == "")
                    rsNroRepo = MessageBox.Show("¿ Desea asignar el Nro de Reporte Automático a los contratos ingresados ?", "MENSAJE", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2);
                ...
                pccTo.TIPO_OPERACION = dtTipoPlla.AsEnumerable().Where(x => x.Field<string>("DESC_TIPO") == cbo_tipo_planilla.Text).CopyToDataTable().Rows[0]["COD_TIPO_PLLA"].ToString();
                ...
                //pccTo.STATUS_NRO_REPORTE = "U";
                pccTo.CERRAR_NRO_REPORTE = rsNroRepo == DialogResult.Yes ? true : false;//chbCerrarReporte.Checked;
                pccTo.COD_NIVEL_INSTITUCION = Convert.ToString(cboNivelInstituciones.SelectedValue);
                dt00.Rows.Clear();
                ...
                else
                {
                    ...
                    {
                        MessageBox.Show("Se adicionó correctamente el Pre-Contrato, \nel Numero de Reporte asignado a los contratos ingresados es : " + nro_repo + " !!!", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        lblMenNroRepo1.Visible = false;
                        lblMenNroRepo2.Visible = false;
                        lblMenNroRepo3.Visible = false;
                        lblMenNroRepo4.Visible = false;
        ...
        private bool validaGrabar()
        {
            ...
            if (bandera == true && codigo_persona != "")
            {
                if (codigo_persona != TXT_COD.Text)
                {
                    MessageBox.Show("VERIFIQUE QUE EL CLIENTE SEA EL CORRECTO !!!", "ADVERTENCIA", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    TXT_COD.Focus();
                    return result = false;
                }
            }
            ...
            //    return result = false;
            //}
            if (cboptocob.SelectedIndex == -1)
            {
                MessageBox.Show("Elija el Punto de Cobranza !!!", "ADVERTENCIA", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                cboptovta.Focus();
                return result = false;
            }
            ...
            if (btn_grabar.Visible)
            {
                ...
                //        MessageBox.Show("ERROR............... !!!! \n" + errMensaje, "MENSAJE", MessageBoxButtons.OK, MessageBoxIcon.Error);
                //}
                if (!validaExistenciaNroContrato())
                    return result = false;
            }
            if (!VerificaNumeracionContrato(numeracion))
                return result = false;
        ...
        private void btnConsultaCliente_Click(object sender, EventArgs e)
        {
            if (TXT_COD.Text.Trim() != "")
            {
                MOD_FACT_VTA.MOD_VTA.CONSULTA_CLIENTE frm = new MOD_FACT_VTA.MOD_VTA.CONSULTA_CLIENTE(TXT_COD.Text);
                frm.ShowDialog();
            }
        }
        ...
        {
            helTo.CODIGO = TXT_COD.Text;
            helTo.CODIGO2 = "2";
            helTo.CODIGO3 = "1";
            DataTable dt = helBLL.obtenerFormaPago_PER_CL_CAT_BLL(helTo);
            if (dt.Rows.Count > 0)
            {
                if (!string.IsNullOrEmpty(dt.Rows[0][0].ToString()))
                {
                    CBO_PAGO.Text = dt.Rows[0][0].ToString();
                    cbo_VENTA.Text = dt.Rows[0][1].ToString();
                    txt_nro_dias.Text = dt.Rows[0][2].ToString();
                }
            }
        ...
        private void dgw_per_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                if (COD_INSTITUCION1 != dgw_per.Rows[idx].Cells["COD_INSTITUCION"].Value.ToString())
                {
        ...
        private void dgw_per2_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                numeracion = dgw_per2.Rows[idx].Cells["NUMERACION"].Value.ToString();
                panel_per2.Visible = false;
                llenaSuperiores();
                VerificaNumeracionContrato(numeracion);
            }
            else if (e.KeyCode == Keys.Escape)
            {
                //Panel_PER.Visible = false;
        ...
        private bool VerificaNumeracionContrato(string numeracion)
        {
            bool result = true;
            if (txt_numero.Text != "" && lblsup.Text != "")
            {
                if (!VERIFICA_NUMERACION(txt_cod2.Text, Convert.ToInt64(txt_numero.Text), numeracion))
                {
        ...
        private bool VERIFICA_NUMERACION(string COD_VEN, decimal nro_con, string numeracion)
        {
            bool flag = false;
            DataTable dt;
            ...
            dt = ncBLL.obtenerTodasNumeracionesBLL();
            //if(numeracion != "True")
            //{
            //    dt = ncBLL.obtenerNumeracionporVendedorBLL(ncTo);
            //}
            //else
            //{
            //    dt = ncBLL.obtenerNumeracionporVendedorconNumeracionVendedorBLL(ncTo);
            //}
            Int64 ini, fin = 0;
            if (dt.Rows.Count > 0)
            {
        ...
        private void btn_guardar2_Click(object sender, EventArgs e)//GUARDA LUEGO DE ESCOGER EL ARTICULO 
        {
        ...
        private void txt_mes_KeyDown(object sender, KeyEventArgs e)
        {
            //if(e.KeyCode == Keys.Enter)
            //{
            //    if (!validaSemanaContrato())
            //        return;
        ...
        private void llenaCbo_Semana_Contrato()
        {
            ...
            if (dtp_oc.Value.ToShortDateString().Length == 10)
                txt_mes.Text = dtp_oc.Value.ToShortDateString().Substring(3, 7);
            else if (dtp_oc.Value.ToShortDateString().Length == 9)
                txt_mes.Text = dtp_oc.Value.ToShortDateString().Substring(2, 7);
            char[] separador = { '/' };
            ...
            if (dtSemanaContrato.Rows.Count > 0)
            {
                ...
                if (val_Semana_Contrato && boton == "NUEVO")
                {
                    MessageBox.Show("No se encontró la fecha de Reporte en ninguna Semana de Reporte,\nREVISELO en el formulario correspondiente !!!", "ADVERTENCIA", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    dtp_oc.Focus();
                }
        ...
        private void CBO_MONEDA_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //        HelpersBLL.OBTIENE_CODIGO(2,DTP_DOC.Value.Day.ToString()),cod_mon);
            //}
        }
        ...
        private void FOCO_NUEVO_REG2(string cont2)
        {
            ...
            for (i = 0; i <= cont; i++)
            {
                //if (nrocon == DGW[7, i].Value.ToString().ToLower())
                if (nrocon == DGW.Rows[i].Cells["Contrato"].Value.ToString().ToLower())
                {
                    //DGW.CurrentCell = DGW.Rows[i].Cells[7];
                    DGW.CurrentCell = DGW.Rows[i].Cells["Contrato"];
                    return;
                }
            }
        ...
        private void CARGAR_DATOS(DataGridView DGW0)
        {
            ...
            COD_INSTITUCION1 = Convert.ToString(DGW0.CurrentRow.Cells["COD_INSTITUCION"].Value);
            COD_NIVEL_INSTITUCION1 = Convert.ToString(DGW0.CurrentRow.Cells["COD_NIVEL_INSTITUCION"].Value);
            CARGAR_NIVEL_INSTITUCIONES(COD_INSTITUCION1, COD_NIVEL_INSTITUCION1);
            ...
            cbo_alm.SelectedValue = DGW0.CurrentRow.Cells["COD_ALMACEN"].Value;
            if (txt_oc.Text.Trim() != "")
                chbVerNroRepManual.Checked = true;
            else
                chbVerNroRepManual.Checked = false;
            calculo_Neto_Cobrar();
        }
        ...
        private bool validaModificarEliminarAnularPrecontrato(string opcion = "anular")
        {
            bool result = true;
            try
            {
            ...
            if (Convert.ToBoolean(DGW.CurrentRow.Cells["Anul"].Value) && opcion == "anular")
            {
        ...
        private void btn_grabar2_Click(object sender, EventArgs e)
        {
            ...
            if (rs == DialogResult.Yes)
            {
                ...
                pccTo.COD_PER = TXT_COD.Text;
                pccTo.COD_CLASE = COD_CLASE1;
                pccTo.FE_AÑO = DGW.CurrentRow.Cells["FE_AÑO"].Value.ToString();//AÑO;
                pccTo.FE_MES = DGW.CurrentRow.Cells["FE_MES"].Value.ToString();//MES;
                pccTo.FECHA_PRE = DTP_DOC.Value;
                pccTo.COD_MONEDA = COD_MONEDA1;
                pccTo.TIPO_CAMBIO = Convert.ToDecimal(TXT_TC.Text);
                pccTo.FORMA_PAGO = COD_FORMA_PAGO;
        ...
        {
            if (!validaModificarEliminarAnularPrecontrato("eliminar"))
                return;
        ...
        private bool validaExistenciaNroContrato()
        {
            bool result = true;
            string errMensaje = "";
            pccTo.COD_SUCURSAL = CBO_SUCURSAL.SelectedValue.ToString();
        ...
        private void mensajeNroReporte()
        {
            string errMensaje = "";
            temporal_Nro_ReporteBLL tnrBLL = new temporal_Nro_ReporteBLL();
            temporal_Nro_ReporteTo tnrTo = new temporal_Nro_ReporteTo();
            tnrTo.cod_per_elab = Convert.ToString(CBO_PERSONAL.SelectedValue);
            if (tnrBLL.verifica_existencia_contratos_sin_nro_reporte_x_cod_digitadorBLL(tnrTo, ref errMensaje))
            {
                //MessageBox.Show("Este usuario digitador tiene contratos que aún no tienen Nro de Reporte !!!", " ADVERTENCIA", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                lblMenNroRepo1.Visible = true;
                lblMenNroRepo2.Visible = true;
                lblMenNroRepo3.Visible = true;
                lblMenNroRepo4.Visible = true;
                ptbGato.Visible = true;
            }
            else
            {
                lblMenNroRepo1.Visible = false;
        ...
        private void DTP_DOC_Leave(object sender, EventArgs e)
        {
            //txt_mes.Text = DTP_DOC.Value.ToShortDateString().Substring(3, 7);
        }
        ...
        private void txt_neto_cob_Leave(object sender, EventArgs e)
        {
            //if(sneto > 0)
            //{
        ...
        private void cboptovta_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cboptovta.SelectedValue != null)
            {
                ...
                //
                llenaLugarVenta();
                if (Convert.ToString(cbo_tipo_planilla.SelectedValue) != "PV")
                {
        ...
        {
            if (COD_INSTITUCION1 != null && cboptovta.SelectedValue != null)
            {
        ...
        private void cboptovta_KeyDown(object sender, KeyEventArgs e)
        {
            //if (e.KeyCode == Keys.Enter)
            //{
            //    TabControl2.SelectedTab = TabPage10;
        ...
        private void cboptocob_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                TabControl2.SelectedTab = TabPage6;
        ...
        private void DTP_DOC_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void btn_AprBlq_Click(object sender, EventArgs e)
        {
            ...
            {
                if (frm.lbl_mensaje_aprobado.Text == "Modificar Plan de Pagos")
                {
            ...
            else
            {
                ...
                {
                    if (modulos_ventas.presupuesto_pedido != null && form.GetType() == typeof(Presentacion.MOD_VTA.PRESUPUESTO_PEDIDO))
                    {
                        modulos_ventas.presupuesto_pedido.DATAGRID();
                    }
                }
                DATAGRID();
            }
        ...
        private void chbVerNroRepManual_CheckedChanged(object sender, EventArgs e)
        {
            if (chbVerNroRepManual.Checked)
                grbNroReporte.Visible = true;
            else
                grbNroReporte.Visible = false;
        }

        private void btnNroReporte_Click(object sender, EventArgs e)
        {
            MOD_FACT_VTA.MOD_VTA.ASIGNA_NRO_REPORTE_X_DIGITADOR frm = new MOD_FACT_VTA.MOD_VTA.ASIGNA_NRO_REPORTE_X_DIGITADOR(COD_USU);
            frm.ShowDialog();
            if (frm.DialogResult == DialogResult.OK)
            {
                DATAGRID();
        ...
        {
            if (Convert.ToString(cbo_tipo_planilla.SelectedValue) == "PV")
                CARGAR_PUNTO_COBRANZA_VISA();// esto se hizo para que cuando elija PV siempre tenga Pto Cob Visa, esto lo pidió la señora, a través de Jorge Rincon
            else
                CARGAR_PUNTO_COBRANZA();
        }
