...
{
    public partial class REP_KARDEX_INVENTARIO : Form
    {
        ...
        public REP_KARDEX_INVENTARIO()
        {
            InitializeComponent();
        }

        private void REP_KARDEX_INVENTARIO_Load(object sender, EventArgs e)
        {
            ...
            reportViewer1.LocalReport.DataSources.Add(new ReportDataSource("KardexInventarioHistorico", lstinv));
