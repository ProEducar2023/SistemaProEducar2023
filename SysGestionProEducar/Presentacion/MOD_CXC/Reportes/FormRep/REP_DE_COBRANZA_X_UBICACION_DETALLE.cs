...
{
    public partial class REP_DE_COBRANZA_X_UBICACION_DETALLE : Form
    {
        ...
        public REP_DE_COBRANZA_X_UBICACION_DETALLE(DataTable dt)
        {
            InitializeComponent();
            this.dt = dt;
        }

        private void REP_DE_COBRANZA_X_UBICACION_DETALLE_Load(object sender, EventArgs e)
        {
            reportViewer1.LocalReport.DataSources.Clear();
            if (act == 1)
                reportViewer1.LocalReport.ReportEmbeddedResource = "Presentacion.MOD_CXC.Reportes.ReportViewer.REP_COBRANZA_UBICACION_X_PERIODO_DETALLE_DIR.rdlc";
            ...
            reportViewer1.LocalReport.DataSources.Add(new ReportDataSource("cobranzaUbicacionDetalle", dt));
