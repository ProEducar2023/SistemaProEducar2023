...
{
    public partial class REP_PLANILLA_ENVIADA_PREVIA : Form
    {
        ...
        public REP_PLANILLA_ENVIADA_PREVIA()
        {
            InitializeComponent();
        }

        private void REP_PLANILLA_ENVIADA_PREVIA_Load(object sender, EventArgs e)
        {
