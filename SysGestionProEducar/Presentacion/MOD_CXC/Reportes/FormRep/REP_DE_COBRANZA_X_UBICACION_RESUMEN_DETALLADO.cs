...
{
    public partial class REP_DE_COBRANZA_X_UBICACION_RESUMEN_DETALLADO : Form
    {
        ...
        public REP_DE_COBRANZA_X_UBICACION_RESUMEN_DETALLADO(DataTable dt)
        {
            InitializeComponent();
            this.dt = dt;
        }

        private void REP_DE_COBRANZA_X_UBICACION_RESUMEN_DETALLADO_Load(object sender, EventArgs e)
        {
            ...
            reportViewer1.LocalReport.DataSources.Add(new ReportDataSource("cobranzaUbicacionResumenDetallado", dt));
