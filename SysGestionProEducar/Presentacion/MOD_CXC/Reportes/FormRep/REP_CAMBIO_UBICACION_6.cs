...
{
    public partial class REP_CAMBIO_UBICACION_6 : Form
    {
        ...
        public REP_CAMBIO_UBICACION_6()
        {
            InitializeComponent();
        }

        private void REP_CAMBIO_UBICACION_6_Load(object sender, EventArgs e)
        {
            ...
            reportViewer1.LocalReport.DataSources.Add(new ReportDataSource("cambiodeUbicacion6", lstpcc));
