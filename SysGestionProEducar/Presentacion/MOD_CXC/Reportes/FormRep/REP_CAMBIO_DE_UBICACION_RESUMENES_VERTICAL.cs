...
{
    public partial class REP_CAMBIO_DE_UBICACION_RESUMENES_VERTICAL : Form
    {
        ...
        public REP_CAMBIO_DE_UBICACION_RESUMENES_VERTICAL()
        {
            InitializeComponent();
        }

        private void REP_CAMBIO_DE_UBICACION_RESUMENES_VERTICAL_Load(object sender, EventArgs e)
        {
            ...
            reportViewer1.LocalReport.DataSources.Add(new ReportDataSource("cambiodeUbicacionResumenVertical", lstpcc));
