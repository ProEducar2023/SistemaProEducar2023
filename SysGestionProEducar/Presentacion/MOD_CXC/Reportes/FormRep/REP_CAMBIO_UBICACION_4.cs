...
{
    public partial class REP_CAMBIO_UBICACION_4 : Form
    {
        ...
        public REP_CAMBIO_UBICACION_4()
        {
            InitializeComponent();
        }

        private void REP_CAMBIO_UBICACION_4_Load(object sender, EventArgs e)
        {
            ...
            reportViewer1.LocalReport.DataSources.Add(new ReportDataSource("cambiodeUbicacion4", lstpcc));
