...
{
    public partial class REP_DE_COBRANZA_X_UBICACION_CANTIDADES : Form
    {
        ...
        public REP_DE_COBRANZA_X_UBICACION_CANTIDADES(DataTable dt)
        {
            InitializeComponent();
            this.dt = dt;
        }

        private void REP_DE_COBRANZA_X_UBICACION_CANTIDADES_Load(object sender, EventArgs e)
        {
