...
{
    public partial class REP_CAMBIO_UBICACION_3 : Form
    {
        ...
        public REP_CAMBIO_UBICACION_3()
        {
            InitializeComponent();
        }

        private void REP_CAMBIO_UBICACION_3_Load(object sender, EventArgs e)
        {
            ...
            reportViewer1.LocalReport.DataSources.Add(new ReportDataSource("cambiodeUbicacion3", lstpcc));
